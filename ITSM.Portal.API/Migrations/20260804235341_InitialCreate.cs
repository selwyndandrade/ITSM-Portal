        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedCompletionTime = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SlaPolicies_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Action = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PreviousUser = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalDecisions_AspNetUsers_DecisionByUserId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ApprovalDecisions_ServiceRequests_ServiceRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalDecisions_DecisionByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalDecisions_ServiceRequestId",
                table: "ApprovalDecisions",
