		...
		<div class="wp-block-group alignwide section__content">
			...
			<div class="wp-block-group alignwide">
				...
				<div class="wp-block-group section__block">
					...
					<h1 class="wp-block-heading is-style-text-giant"><?php echo wp_kses_post( _x( 'AI-powered IT<br>operations, simplified<span class="dot">.</span>', 'Hero section title', 'mroya' ) ); ?></h1>
					<!-- /wp:heading -->
					...
					<div class="wp-block-group">
						...
						<p class="has-contrast-2-color has-text-color has-link-color has-medium-font-size" style="font-style:normal;font-weight:500;letter-spacing:-0.01em"><?php echo esc_html_x( 'Kyro helps teams manage incidents, automate workflows, and resolve IT problems faster with intelligent AI assistance.', 'Hero section text', 'mroya' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
				</div>
		...
		<footer class="wp-block-group alignwide section__footer">
			...
			<div class="wp-block-buttons">
				...
				<div class="wp-block-button is-style-link-7">
					<a class="wp-block-button__link wp-element-button" href="https://app.kyro.tech/register"><?php echo esc_html_x( 'Start Free Trial', 'Hero section button text', 'mroya' ); ?></a>
				</div>
				<!-- /wp:button -->

				<!-- wp:button {"className":"is-style-link-6"} -->
				<div class="wp-block-button is-style-link-6">
					<a class="wp-block-button__link wp-element-button" href="https://kyro.tech/product"><?php echo esc_html_x( 'Explore Platform', 'Hero section button text', 'mroya' ); ?></a>
				</div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
			...
			<div class="wp-block-group">
				...
				<p class="is-style-text-mono"><?php echo esc_html_x( 'Kyro IT Service Management', 'Hero section text', 'mroya' ); ?></p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph {"className":"local-time is-style-text-mono"} -->
				<p class="is-style-text-mono"><?php echo esc_html_x( 'AI-powered support', 'Hero section text', 'mroya' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</footer>
