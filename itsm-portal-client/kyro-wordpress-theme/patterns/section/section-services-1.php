...
<section class="wp-block-group alignfull section section--services-1" id="section-services-1" style="margin-top:0;padding-top:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--10)">
	...
	<header class="wp-block-group alignwide section__header">
		...
		<h2 class="wp-block-heading is-style-text-mono"><?php echo esc_html_x( '[ Features ]', 'Services section title', 'mroya' ); ?></h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"className":"is-style-text-mono"} -->
		<p class="is-style-text-mono"><?php echo esc_html_x( '# Built for modern IT teams', 'Services section text', 'mroya' ); ?></p>
		<!-- /wp:paragraph -->
	</header>
	<!-- /wp:group -->
		...
		<div class="wp-block-group alignwide services-list">
			...
			<div class="wp-block-group services-list__item" style="padding-bottom:var(--wp--preset--spacing--60)">
				...
				<div class="wp-block-group item__block--text">
					...
					<h3 class="wp-block-heading item__title has-huge-font-size"><?php echo esc_html_x( 'Meyon', 'Services section item title', 'mroya' ); ?></h3>
					<!-- /wp:heading -->
					...
					<div class="wp-block-group">
						...
						<p class="item__description has-contrast-color has-text-color has-link-color has-medium-font-size" style="font-style:normal;font-weight:500"><?php echo esc_html_x( 'A context-aware assistant that helps employees troubleshoot issues, surface knowledge, and turn problems into ready-to-review tickets.', 'Services section item text', 'mroya' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
			...
			<div class="wp-block-group services-list__item" style="padding-bottom:var(--wp--preset--spacing--60)">
				...
				<div class="wp-block-group item__block--text">
					<!-- wp:heading {"level":3,"className":"item__title","fontSize":"huge"} -->
					<h3 class="wp-block-heading item__title has-huge-font-size"><?php echo esc_html_x( 'Smart Ticket Management', 'Services section item title', 'mroya' ); ?></h3>
					<!-- /wp:heading -->
					...
					<div class="wp-block-group">
						...
						<p class="item__description has-contrast-color has-text-color has-link-color has-medium-font-size" style="font-style:normal;font-weight:500"><?php echo esc_html_x( 'Manage incidents, requests, workflows, and IT operations from one centralized platform.', 'Services section item text', 'mroya' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
			...
			<div class="wp-block-group services-list__item" style="padding-bottom:var(--wp--preset--spacing--60)">
				...
				<div class="wp-block-group item__block--text">
					<!-- wp:heading {"level":3,"className":"item__title","fontSize":"huge"} -->
					<h3 class="wp-block-heading item__title has-huge-font-size"><?php echo esc_html_x( 'Knowledge Intelligence', 'Services section item title', 'mroya' ); ?></h3>
					<!-- /wp:heading -->

					<!-- wp:group {"layout":{"type":"constrained","contentSize":"620px","wideSize":"100%","justifyContent":"left"}} -->
					<div class="wp-block-group">
						<!-- wp:paragraph {"className":"item__description","style":{"typography":{"fontStyle":"normal","fontWeight":"500"},"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"textColor":"contrast","fontSize":"medium"} -->
						<p class="item__description has-contrast-color has-text-color has-link-color has-medium-font-size" style="font-style:normal;font-weight:500"><?php echo esc_html_x( 'Give teams instant answers using an intelligent knowledge base.', 'Services section item text', 'mroya' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
